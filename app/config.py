...
QDRANT_LOCAL_IMAGE_MODEL = os.getenv(
    "QDRANT_LOCAL_IMAGE_MODEL", "Qdrant/clip-ViT-B-32-vision"
)

SEARCH_PREFETCH_LIMIT = int(os.getenv("SEARCH_PREFETCH_LIMIT", "50"))
QDRANT_QUERY_IMAGE_MAX_DIMENSION = int(
    os.getenv("QDRANT_QUERY_IMAGE_MAX_DIMENSION", "1600")
)
QDRANT_QUERY_IMAGE_JPEG_QUALITY = int(
    os.getenv("QDRANT_QUERY_IMAGE_JPEG_QUALITY", "85")
)
